...
- created new psw policy (pswd length, expiry 90 days)
...
- download Windows 11 client         
- created new vm for client, chose windows 11 pro      -> should I add this and that^^ on Phase 1? yea probably
